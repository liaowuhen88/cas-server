(function (i) {
    ...
    i(document).ready(function () {
        ...
        i(document).bind("MSGestureEnd", function (v) {
            ...
            q = Date.now();
            t = q - (g.last || q);
            g.el = i("tagName" in s.target ? s.target : s.target.parentNode);
            c && clearTimeout(c);
            g.x1 = s.pageX;
            g.y1 = s.pageY;
            if (t > 0 && t <= 250) {
            ...
            g.x2 = s.pageX;
            g.y2 = s.pageY;
            p += Math.abs(g.x1 - g.x2);
            o += Math.abs(g.y1 - g.y2);
