function searchZhongAnButton() {
    requestParams.push({"name": "status[0]", "value": 4});
    requestParams.push({"name": "status[1]", "value": 5});
    requestParams.push({"name": "status[3]", "value": 7});
    requestParams.push({"name": "status[4]", "value": 8});
}
