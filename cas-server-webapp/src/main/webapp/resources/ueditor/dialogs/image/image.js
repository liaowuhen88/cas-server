...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                ...
                date=(function(){
                    var dateObject={};
                    var date=new Date();
                    dateObject['yyyy']=date.getFullYear().toString();
                    dateObject['mm']=date.getMonth()+1>=10 ? date.getMonth()+1 : ""+date.getMonth()+1;
                    dateObject['dd']=date.getDate().toString();
                    dateObject['hh']=date.getHours().toString();
                    dateObject['mi']=date.getMinutes().toString();
                    dateObject['ss']=date.getSeconds().toString();
                    dateObject['ymd']=dateObject.yyyy+dateObject.mm+dateObject.dd;
                    dateObject['hms']=dateObject.hh+dateObject.mi+dateObject.ss;
                    dateObject['time']=date.getTime();
                   return dateObject;
                })(),
                urlPath=date.ymd+"/"+date.hh+"/"+date.ymd+date.hms+"_",

            serverUrl=window.UE.getRootPath+"/upload/uploadResImage/image/article/"+urlPath;
        ...
        getInsertList: function () {
            ...
            console.info(this.imageList+"this.imageList.length");
