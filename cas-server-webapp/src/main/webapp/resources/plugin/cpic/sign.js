...
function anysignWebImpl() {
    this._initAnySignApi = function(n, i) {
        ...
        this._isReadyToUpload = function() {
            ...
            var n = !1;
            console.info(signObjArray);
            for (var i in signObjArray) {
                var e = signObjArray[i], t = e.cid;
                console.info(e);
                console.info(signData[t]);
                console.info(signObjArray[t]);
                if (null == signData[t] && signObjArray[t].isNecessary){
                    return ! 1;
                }
            ...
            console.info(mDataObjArray);
            for (i in mDataObjArray) {
                var e = mDataObjArray[i];
                console.info(e);
                if (null == mDatas[e.cid] && e.nessesary){
                    return ! 1
                }
            }
            return ! 0
