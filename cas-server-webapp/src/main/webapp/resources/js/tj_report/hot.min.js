(function (c, b) {
    var a = {};
    (function () {
        var l = b.querySelector('meta[name="viewport"]'), i = b.querySelector('meta[name="hotcss"]'), k = c.devicePixelRatio || 1, m = 540, h = 0;
        if (i) {
        ...
        var e = 1 / k, g = "width=device-width, initial-scale=" + e + ", minimum-scale=" + e + ", maximum-scale=" + e + ", user-scalable=no";
        if (l) {
